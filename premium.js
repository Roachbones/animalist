...
CUSTOM_ADS = [
    ...
    '<iframe width=200 height=200 src=https://robinsaviary.com/translink-frame frameBorder=0 scrolling=no></iframe><p>oh no you got a distracting one that changes every 30 seconds<p><small>(these are random indie sites I have not vetted)</small>',
    ...
    '<iframe width=180 height=180 src=https://evehibi.nekoweb.org/ringlink/></iframe><p>oh no you got a distracting one that changes every 30 seconds<p><small>(these are random webrings I have not vetted)</small>',
